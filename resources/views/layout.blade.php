											...
											<div class="card-body d-flex flex-column p-0">
												...
												<div class="flex-grow-1 card-p pb-0">
													<div class="d-flex flex-stack flex-wrap">
														<div class="me-2">
															<a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Reporte General</a>
															<div class="text-muted fs-7 fw-bold">Ingresos y Egresos</div>
														</div>
														<div class="fw-bolder fs-3 text-primary">S/. 20,500</div>
													</div>
												</div>
												<!--end::Stats-->
												<!--begin::Chart-->
										...
										<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
											...
											<div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
												...
												<div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
													...
													<div class="fw-bolder fs-3 text-primary">S/25,300</div>
												</div>
												<!--end::Hidden-->
												<!--begin::Chart-->
