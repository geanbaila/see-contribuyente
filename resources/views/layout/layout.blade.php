								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										<li class="breadcrumb-item text-dark">
											<a href="{{url('/')}}" class="btn btn-sm btn-secondary active">Cargas y encomiendas</a>
										</li>
										<li class="breadcrumb-item text-dark">
											...
											<div class="card-body pt-9 pb-0">
												...
												<div class="row">
													...
													<div class="col-4 text-end align-top">
														...
														<a class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"><img src="{{asset('assets/media/icons/sis/search.svg')}}" width="24"/></a>
								...
								<form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
									...
									<div class="d-flex flex-stack pt-10">
										...
										<div>
											...
											<button type="button" class="btn btn-lg btn-primary" data-kt-stepper-action="next">Generar Boleta E. / Factura E.
											<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
